...
class Prototype extends Entity\DataManager
{
	 ...
	 *
	 * @return \Site\Main\Hlblock\Prototype
	 * @throws \Site\Main\Exception
	 *
	 */
	...
	/**
	 * Определяет константы вида Site\Main\Hblock\ID_{CODE} и Site\Main\Hblock\CODE_{ID} для всех highload-блоков
	 *
