...
$APPLICATION->SetTitle($title); ?>
    ...
    <h3>Описание</h3>
	<p>Компонент  наследующий  функциональность news.list c меньшим количеством запросов SQL за счет выборки только указанных в параметрах свойств и полей, убранной проверки на существование инфоблока, мета свойств(вкладка Seo) и выборки по подразделам</p>
